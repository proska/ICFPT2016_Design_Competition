...
public class SpriteStore {
    ...
    private static int spriteSize = 20;

    public static void setSpriteSize(int spriteSize) {
        SpriteStore.spriteSize = spriteSize;
    }
    ...
    public Sprite getSprite(String ref) {
        ...
        Image imageScaled = image.getScaledInstance(spriteSize,spriteSize,Image.SCALE_DEFAULT);

        Sprite sprite = new Sprite(imageScaled);
